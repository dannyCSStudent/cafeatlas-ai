...
const notes = [
  {
    title: "Process label first",
    body: "Washed, natural, and honey are the quickest cues for how the coffee was handled after harvest.",
  },
  {
    title: "Read structure",
    body: "Process often changes sweetness, body, clarity, and how acidity shows up in the cup.",
  },
  {
    title: "Separate it from flavor",
    body: "A natural coffee is not always fruit-heavy, and a washed coffee is not always light or clean.",
  },
  {
    title: "Compare within origin",
    body: "The note becomes easier to hear when you compare coffees from the same place.",
  },
];

export default function ReadProcessScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <DetailScreenShell
        ...
        media={
          <View style={[styles.mediaCard, { borderColor: theme.border, backgroundColor: theme.surfaceStrong }]}>
            ...
            <View style={styles.mediaCopy}>
              ...
              <ThemedText type="subtitle">How to read process</ThemedText>
              <ThemedText style={[styles.mediaBody, { color: theme.mutedText }]}>
                A quick note on how washed, natural, and honey processing show up as cues in the profile.
              </ThemedText>
              <ArticleMeta
        ...
        description="A short origin note for understanding process as a profile cue."
        topStats={[
          { label: "Steps", value: "4" },
          { label: "Focus", value: "Process" },
        ]}
        bottomStats={[
      ...
      >
        ...
        <View style={[styles.section, { borderColor: theme.border, backgroundColor: theme.surfaceMuted }]}>
          ...
          <ThemedText style={[styles.body, { color: theme.mutedText }]}>
            A washed coffee may feel clearer or more structured, while a natural lot can feel broader or more
            expressive, but the relationship is never automatic.
          </ThemedText>
          <ThemedText style={[styles.body, { color: theme.mutedText }]}>
            Compare process across coffees from the same origin so you can hear what changed without losing context.
          </ThemedText>
        </View>
      </DetailScreenShell>
    </ScrollView>
