...
const steps = [
  {
    title: "Flavor goal first",
    body: "Decide whether you want bright, balanced, fruit-forward, or deeper sweetness before you start browsing.",
  },
  {
    title: "Origin and process",
    body: "Use producer, farm, state, and process to narrow the catalog before reading the notes.",
  },
  {
    title: "Read the notes",
    body: "Use tasting notes to check whether the profile matches the cup you want.",
  },
  {
    title: "Confirm freshness",
    body: "Roast timing and the surrounding story help you pick a coffee that should drink the way you expect.",
  },
];

export default function ChooseCoffeeGuideScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <DetailScreenShell
        ...
        media={
          <View style={[styles.mediaCard, { borderColor: theme.border, backgroundColor: theme.surfaceStrong }]}>
            ...
            <View style={styles.mediaCopy}>
              ...
              <ThemedText type="subtitle">How to choose a coffee</ThemedText>
              <ThemedText style={[styles.mediaBody, { color: theme.mutedText }]}>
                A quick way to match the catalog to the cup you want.
              </ThemedText>
              <ArticleMeta
        ...
        description="A short guide for turning the catalog into a practical buying path."
        topStats={[
          { label: "Steps", value: "4" },
          { label: "Focus", value: "Buying" },
        ]}
        bottomStats={[
      ...
      >
        ...
        <View style={[styles.section, { borderColor: theme.border, backgroundColor: theme.surfaceMuted }]}>
          ...
          <View style={styles.chips}>
            {["Origin", "Process", "Notes", "Freshness"].map((item) => (
