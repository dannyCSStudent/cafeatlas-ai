...
const steps = [
  {
    ...
    body: "Notice the balance between sweetness, acidity, and body before chasing flavor words.",
  },
  {
    title: "Name the first impression",
    body: "Identify whether the coffee feels bright, round, soft, or structured at first sip.",
  },
  {
    title: "Use notes as clues",
    body: "Tasting notes should point you back to the cup instead of replacing it.",
  },
  {
    title: "Compare across coffees",
    body: "Comparison makes tasting easier when you keep origin and process context visible.",
  },
];

export default function HowToTasteACoffeeScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <DetailScreenShell
        ...
        media={
          <View style={[styles.mediaCard, { borderColor: theme.border, backgroundColor: theme.surfaceStrong }]}>
            ...
            <View style={styles.mediaCopy}>
              ...
              <ThemedText type="subtitle">How to taste a coffee</ThemedText>
              <ThemedText style={[styles.mediaBody, { color: theme.mutedText }]}>
                A sensory note for reading sweetness, acidity, and structure with more clarity.
              </ThemedText>
              <ArticleMeta
        ...
        description="A short sensory guide for reading sweetness, acidity, and structure with more clarity."
        topStats={[
          { label: "Steps", value: "4" },
          { label: "Focus", value: "Taste" },
        ]}
        bottomStats={[
      ...
      >
        ...
        <View style={[styles.section, { borderColor: theme.border, backgroundColor: theme.surfaceMuted }]}>
          ...
          <ThemedText style={[styles.body, { color: theme.mutedText }]}>
            Tasting notes should point you back to the cup, not replace the cup itself.
          </ThemedText>
        </View>
      </DetailScreenShell>
    </ScrollView>
