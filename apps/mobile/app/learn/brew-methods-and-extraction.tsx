...
export default function BrewMethodsAndExtractionScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <DetailScreenShell
        ...
        media={
          <View style={[styles.mediaCard, { borderColor: theme.border, backgroundColor: theme.surfaceStrong }]}>
            ...
            <View style={styles.mediaCopy}>
              ...
              <ThemedText type="subtitle">Brew methods and extraction</ThemedText>
              <ThemedText style={[styles.mediaBody, { color: theme.mutedText }]}>
                The final Learn piece, focused on how brewing changes what you taste.
              </ThemedText>
              <ArticleMeta
        ...
        description="A practical Learn article that keeps brewing in the same editorial system as the catalog."
        topStats={[
          { label: "Steps", value: "4" },
          { label: "Lens", value: "Brew" },
        ]}
        bottomStats={[
      ...
      >
        ...
        <View style={[styles.section, { borderColor: theme.border, backgroundColor: theme.surfaceMuted }]}>
          ...
          <View style={styles.chips}>
            {["Learn hub", "Reading guide", "Seasonal notes", "Glossary"].map((item) => (
              <Pressable
                key={item}
                onPress={() =>
                  router.push(
