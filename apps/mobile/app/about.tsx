        ...
        actions={
          <>
            ...
            <Pressable
              ...
              style={[styles.secondaryButton, { borderColor: theme.border, backgroundColor: theme.surfaceStrong }]}
            >
              <ThemedText type="defaultSemiBold">Choose a coffee</ThemedText>
            </Pressable>
            <Pressable
            ...
            <Pressable
              onPress={() => router.push("/learn/how-to-read-body")}
              style={[styles.secondaryButton, { borderColor: theme.border, backgroundColor: theme.surfaceStrong }]}
            >
              <ThemedText type="defaultSemiBold">Read body</ThemedText>
            </Pressable>
            <Pressable
              onPress={() => router.push("/learn/how-to-read-varietal")}
              style={[styles.secondaryButton, { borderColor: theme.border, backgroundColor: theme.surfaceStrong }]}
            >
              <ThemedText type="defaultSemiBold">Read varietal</ThemedText>
            </Pressable>
            <Pressable
            ...
            <Pressable
              onPress={() => router.push("/learn/how-to-store-coffee")}
              style={[styles.secondaryButton, { borderColor: theme.border, backgroundColor: theme.surfaceStrong }]}
            >
              <ThemedText type="defaultSemiBold">Store coffee</ThemedText>
            </Pressable>
          </>
        }
        media={
