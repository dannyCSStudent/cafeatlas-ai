...
const steps = [
  {
    title: "Start with the flavor goal",
    body:
      "Decide whether you want something bright, balanced, fruit-forward, or deeper and sweeter before you filter the catalog.",
  },
  {
    title: "Use origin and process",
    body:
      "Producer, farm, state, and process help you narrow the options before you ever read the tasting notes.",
  },
  {
    title: "Read the notes with context",
    body:
      "Look for the words that match your target cup, then compare them with the profile, not in isolation.",
  },
  {
    title: "Confirm with freshness",
    body:
      "Check roast timing and the story around the lot so you can choose a coffee that is likely to drink the way you want.",
  },
];

export default function ChooseCoffeeGuidePage() {
  return (
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-2xl text-lg leading-8 text-[var(--site-text-soft)]">
                This guide helps you match the catalog to the kind of cup you want before you commit to a bag.
              </p>
          ...
          <div className="flex flex-col justify-between gap-5 rounded-[1.75rem] border border-[var(--site-border)] bg-[var(--site-surface-card-strong)] p-5">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm leading-7 text-[var(--site-text-soft)]">
                The goal is to make origin, process, tasting notes, and freshness easier to use as a buying filter.
              </p>
            </div>
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-2xl border border-[var(--site-border)] bg-[var(--site-surface-card)] p-4">
                ...
                <p className="mt-2 text-base font-semibold">Flavor goal</p>
              </div>
              <div className="rounded-2xl border border-[var(--site-border)] bg-[var(--site-surface-card)] p-4">
                <p className="text-xs uppercase tracking-[0.22em] text-[var(--site-muted)]">Then</p>
                <p className="mt-2 text-base font-semibold">Origin and process</p>
              </div>
            </div>
          </div>
        </header>
        ...
        <section className="grid gap-6 lg:grid-cols-[1fr_0.9fr]">
          <article className="rounded-[2rem] border border-[var(--site-border)] bg-[var(--site-surface-card)] p-6 shadow-[0_24px_90px_rgba(102,62,22,0.08)] backdrop-blur">
            ...
            <div className="mt-4 space-y-4 text-sm leading-7 text-[var(--site-text-soft)]">
              <p>
                When you want something brighter, start with coffees that read clearly in the origin and process
                fields, then use tasting notes to check that the cup language matches your goal.
              </p>
              <p>
                When you want something more balanced or sweet, look for profiles where freshness, roast balance, and
                origin story all point in the same direction instead of pulling apart.
              </p>
              <p>
                If you are undecided, compare two coffees side by side and let the live catalog narrow the choice for
                you.
              </p>
            </div>
          </article>
          ...
          <article className="rounded-[2rem] border border-[var(--site-border)] bg-[var(--site-inverse)] p-6 text-[var(--site-inverse-foreground)] shadow-[0_24px_90px_rgba(28,17,8,0.18)]">
            ...
            <p className="mt-5 text-sm leading-7 text-[var(--site-inverse-muted)]">
              This guide helps turn the catalog into a practical decision path while keeping origin visible.
            </p>
          </article>
        </section>
      </section>
