...
const steps = [
  {
    title: "Start broad",
    body:
      "Use the search field or open the live catalog first so you can see how the current dataset is shaped.",
  },
  {
    title: "Narrow by origin",
    body:
      "Filter by state or producer when you want to stay close to a region or a farming relationship.",
  },
  {
    title: "Use featured and sort",
    body:
      "Featured lots and sort modes help you choose whether you want the current spotlight or the newest options.",
  },
  {
    title: "Open the story",
    body:
      "Once a coffee looks promising, open the detail page and keep following the producer and farm links.",
  },
];

export default function FilterCatalogGuidePage() {
  return (
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-2xl text-lg leading-8 text-[var(--site-text-soft)]">
                This guide shows how to narrow the live catalog without losing sight of the origin story.
              </p>
          ...
          <div className="flex flex-col justify-between gap-5 rounded-[1.75rem] border border-[var(--site-border)] bg-[var(--site-surface-card-strong)] p-5">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm leading-7 text-[var(--site-text-soft)]">
                The goal is to turn search and filters into a practical path through the catalog.
              </p>
            </div>
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-2xl border border-[var(--site-border)] bg-[var(--site-surface-card)] p-4">
                ...
                <p className="mt-2 text-base font-semibold">Search</p>
              </div>
              <div className="rounded-2xl border border-[var(--site-border)] bg-[var(--site-surface-card)] p-4">
                <p className="text-xs uppercase tracking-[0.22em] text-[var(--site-muted)]">Then</p>
                <p className="mt-2 text-base font-semibold">Origin filters</p>
              </div>
            </div>
          </div>
        </header>
        ...
        <section className="grid gap-6 lg:grid-cols-[1fr_0.9fr]">
          <article className="rounded-[2rem] border border-[var(--site-border)] bg-[var(--site-surface-card)] p-6 shadow-[0_24px_90px_rgba(102,62,22,0.08)] backdrop-blur">
            ...
            <div className="mt-4 space-y-4 text-sm leading-7 text-[var(--site-text-soft)]">
              <p>
                Start broad, then narrow the field until the list reflects the kind of cup you want and the origin you
                want to keep in view.
              </p>
              <p>
                If you are comparing options, sort by newest or featured so you can decide whether you want the current
                spotlight or a broader set of choices.
              </p>
              <p>
                When a coffee looks right, open the detail page and keep following the chain to the producer and farm.
              </p>
            </div>
          </article>
          ...
          <article className="rounded-[2rem] border border-[var(--site-border)] bg-[var(--site-inverse)] p-6 text-[var(--site-inverse-foreground)] shadow-[0_24px_90px_rgba(28,17,8,0.18)]">
            ...
            <p className="mt-5 text-sm leading-7 text-[var(--site-inverse-muted)]">
              This note keeps the browsing model practical while preserving the catalog&apos;s origin-focused tone.
            </p>
          </article>
        </section>
      </section>
