          ...
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="max-w-2xl">
              ...
              <p className="mt-3 text-sm leading-7 text-[var(--site-text-soft)]">
                ...
                notes, then the varietal note, then the process note, then the altitude note, then the sourcing
                note, then the comparison note, then the storage note, then the brew clarity note. That gives you
                the shortest path from structure to buying, search, origin, comparison, altitude, tasting,
                sweetness, body, varietal, process, freshness, change, extraction, and balance.
              </p>
            </div>
            <div className="flex flex-wrap gap-2">
          ...
          <article className="rounded-[2rem] border border-[var(--site-border)] bg-[var(--site-inverse)] p-5 text-[var(--site-inverse-foreground)] shadow-[0_24px_90px_rgba(28,17,8,0.18)]">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {[
                ...
                { href: "/learn/how-to-read-altitude", label: "Altitude note" },
