...
const steps = [
  ...
  },
  {
    ...
    body: "The cup tells you when a coffee is at its best. Compare the opening days with the later ones.",
  },
];

export default function HowToStoreCoffeePage() {
  return (
        ...
        <header className="grid gap-8 rounded-[2.25rem] border border-[var(--site-border)] bg-[var(--site-surface-card)] p-6 shadow-[0_24px_90px_rgba(102,62,22,0.08)] backdrop-blur lg:grid-cols-[1.1fr_0.9fr] lg:p-8">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl font-semibold tracking-tight text-balance sm:text-5xl">How to store coffee.</h1>
              <p className="max-w-2xl text-lg leading-8 text-[var(--site-text-soft)]">
                This freshness note helps you keep roast date, bag handling, and timing in view after the coffee
                leaves the roaster.
              </p>
          ...
          <div className="flex flex-col justify-between gap-5 rounded-[1.75rem] border border-[var(--site-border)] bg-[var(--site-surface-card-strong)] p-5">
            ...
            <div className="space-y-3">
              ...
              <p className="text-sm leading-7 text-[var(--site-text-soft)]">
                The goal is to make freshness feel practical, so the cup stays readable after you bring the coffee
                home.
              </p>
            </div>
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="rounded-2xl border border-[var(--site-border)] bg-[var(--site-surface-card)] p-4">
                ...
                <p className="mt-2 text-base font-semibold">Roast date</p>
              </div>
              <div className="rounded-2xl border border-[var(--site-border)] bg-[var(--site-surface-card)] p-4">
                <p className="text-xs uppercase tracking-[0.22em] text-[var(--site-muted)]">Then</p>
                <p className="mt-2 text-base font-semibold">Sealed storage</p>
              </div>
            </div>
          </div>
        </header>
        ...
        <section className="grid gap-6 lg:grid-cols-[1fr_0.9fr]">
          <article className="rounded-[2rem] border border-[var(--site-border)] bg-[var(--site-surface-card)] p-6 shadow-[0_24px_90px_rgba(102,62,22,0.08)] backdrop-blur">
            ...
            <div className="mt-4 space-y-4 text-sm leading-7 text-[var(--site-text-soft)]">
              <p>
                If a coffee tastes flat early, storage is only one factor, but it is a practical one you can control.
              </p>
              <p>
                Opening the bag, using it steadily, and keeping the contents sealed between brews will usually tell you
                more than a complicated container.
              </p>
              <p>
                The freshest cup is not always the first day. Use the first few brews to find the coffee&apos;s sweet
                spot.
              </p>
            </div>
          </article>
          ...
          <article className="rounded-[2rem] border border-[var(--site-border)] bg-[var(--site-inverse)] p-6 text-[var(--site-inverse-foreground)] shadow-[0_24px_90px_rgba(28,17,8,0.18)]">
            ...
            <p className="mt-5 text-sm leading-7 text-[var(--site-inverse-muted)]">
              This note gives the Learn section a practical freshness lens for keeping coffee readable after purchase.
            </p>
          </article>
        </section>
      </section>
