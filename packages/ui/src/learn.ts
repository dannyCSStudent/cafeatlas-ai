export const LEARN_ARTICLES = [
  ...
  },
  {
    ...
    body: "A grounded look at extraction, water, and the variables that shape the cup.",
    tag: "Science note",
    readTime: "3 min",
    updated: "Sep 1, 2026",
  },
  {
    ...
    title: "Brew recipes",
    body: "Three starting recipes for clarity, balance, and immersion brewing.",
    tag: "Recipe note",
    readTime: "3 min",
    updated: "Sep 1, 2026",
  },
  {
    ...
    body: "A deeper editorial note on washed, honey, and natural coffee processing.",
    tag: "Processing note",
    readTime: "3 min",
    updated: "Sep 1, 2026",
  },
  {
    ...
    body: "A practical guide to the grinder, brewer, kettle, scale, and filter choices that matter.",
    tag: "Equipment note",
    readTime: "3 min",
    updated: "Sep 1, 2026",
  },
